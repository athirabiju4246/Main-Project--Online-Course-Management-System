              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li><a href="coursecart/shopping/viewcourses.php">Instructors</a></li>
                          <li><a href="coursecart/shopping/category.php">Courses</a></li>
                          <li class="has-sub">
                              <a href="javascript:void(0)">Assignments</a>
                              <ul class="sub-menu">
                                <li><a href="studentaddassignment.php">Assignments</a></li>
                          ...
                          <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                <li><a href="shopping/videos/studentviewvideo.php">videos</a></li>
                          ...
                          <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                <li><a href="scheduleviewstudent.php">Schedules</a></li>
