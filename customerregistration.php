...
$sql="select * from tbl_login where (email='$email' or password='$password');";
 ...
 $sql1 = "INSERT INTO tbl_customerreg (`logid`,`name`,`phone`,`course`,`gender`,`dob`,`cpassword`) VALUES ('$logid', '$name', '$phone', '$course', '$gender', '$dob', '$cpassword' )";
 //$sql2 = "INSERT INTO tbl_login (email,password,role) VALUES ('$email','$password','student')";
...
<body>
    <form  id="create-account-form" action="" method="POST">
        ...
        <div class="input-group">
            ...
            <input type="text" id="name"name="name" onkeyup="fnameValidation(this)">
