				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<?php if($row['productAvailability']=='In Stock'){?>
							...
							<a href="#?page=product&action=add&id=<?php echo $row['id']; ?>">
							...
							<?php
								...
								if(mysqli_num_rows($check_isbooked) > 0){
									...
									?>
									<div class="action" style="color:red"><a href="Booking.php?cid=<?php echo $row['cid']?>&sid=<?php echo $sid; ?>">Book</a></div>&nbsp&nbsp<br>
									<div class="action" style="color:red"><a href="cancelrequest.php?cid=<?php echo $row['cid']?>&sid=<?php echo $sid; ?>">Cancel</a></div>
									<?php
								}
							?>
					<?php } ?>
