...
//$sql1="select * from tbl_studentregister where (email='$email' or cpassword='$password');";
...
$sql = "INSERT INTO tbl_studentregister (`logid`,`name`,`phone`,`course`,`gender`,`dob`,`cpassword`) VALUES ('$logid', '$name', '$phone', '$course', '$gender', '$dob', '$cpassword')";
